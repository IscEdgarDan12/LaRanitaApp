...
public class Login extends javax.swing.JFrame {
    ...
    public void sesion(String usuario, String contra) {
        String sqlContra = "SELECT * FROM usuarios WHERE usuario='" + usuario + "'";
        ...
        try {
            ...
            if (rs != null) {
                System.out.println("entro antes del while");
                if (rs.next()) {
                    ...
                    if (pass.equals(contra)) {
                        ...
                        if (Usuario.equals(usuario)) {
                            if (getIntentos() < 3) {
                                ...
                                JOptionPane.showMessageDialog(null, "Numero de intentos: " + getIntentos());
                            } else {
                                JOptionPane.showMessageDialog(null, "La Cuenta a sido Eliminada por cuestiones de seguridad");
                                System.out.println(Usuario);
                                String deletePro = "delete from usuarios where idUsuarios='" + valorId + "'AND usuario='" + Usuario + "';";
